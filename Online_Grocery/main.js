...
//		 itemsProducts.innerHTML += cartItems.items[i].name;
//		 itemsProducts.innerHTML += cartItems.items[i].amount;
//		 itemsProducts.innerHTML += cartItems.items[i].imgSrc;
//		 itemsProducts.innerHTML += cartItems.items[i].price;
	 }
